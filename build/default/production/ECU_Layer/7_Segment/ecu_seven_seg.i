...
# 13 "ECU_Layer/7_Segment/ecu_seven_seg.c"
...
# 13 "ECU_Layer/7_Segment/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 13 "ECU_Layer/7_Segment/ecu_seven_seg.c" 2
...
STD_ReturnType Seven_Segment_Initialize(const Segment_t *segment ){
    ...
    if(segment != ((void*)0)){
        gpio_pin_initialize(&(segment->segments_pins[((uint8)0)]));
        gpio_pin_initialize(&(segment->segments_pins[((uint8)1)]));
        gpio_pin_initialize(&(segment->segments_pins[((uint8)2)]));
        gpio_pin_initialize(&(segment->segments_pins[((uint8)3)]));
    }
    else{
...
STD_ReturnType Seven_Sement_Write_Number(const Segment_t *segment , uint8 number){
    ...
    STD_ReturnType Status = (STD_ReturnType)0x01;
    if(segment != ((void*)0)){
        gpio_pin_write_logic(&(segment->segments_pins[((uint8)0)]), number&(uint8)0x01);
        gpio_pin_write_logic(&(segment->segments_pins[((uint8)1)]),(number >> 1)& (uint8)0x01);
        gpio_pin_write_logic(&(segment->segments_pins[((uint8)2)]),(number >> 2)& (uint8)0x01);
        gpio_pin_write_logic(&(segment->segments_pins[((uint8)3)]),(number >> 3)& (uint8)0x01);
    }
    else{
