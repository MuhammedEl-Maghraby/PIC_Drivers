...
# 10 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c" 2
...
STD_ReturnType lcd_4bit_initialize(const chr_lcd_4bit_t *lcd){
    ...
    uint8 l_data_pins_counter = 0x00;
    if(lcd != ((void*)0)){
        ...
        Status = lcd_4bit_send_command(lcd,0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        Status = lcd_4bit_send_command(lcd,0x38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        Status = lcd_4bit_send_command(lcd,0x38);

        Status = lcd_4bit_send_command(lcd,0x01);
        Status = lcd_4bit_send_command(lcd,0x02);
        Status = lcd_4bit_send_command(lcd,0x06);
        Status = lcd_4bit_send_command(lcd,0x0C);
        Status = lcd_4bit_send_command(lcd,0x28);
...
STD_ReturnType lcd_8bit_initialize(const chr_lcd_8bit_t *lcd){
    ...
    if(lcd != ((void*)0)){
        ...
        _delay((unsigned long)((20)*(8000000/4000.0)));
        Status = lcd_8bit_send_command(lcd,0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        Status = lcd_8bit_send_command(lcd,0x38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        Status = lcd_8bit_send_command(lcd,0x38);

        Status = lcd_8bit_send_command(lcd,0x01);
        Status = lcd_8bit_send_command(lcd,0x02);
        Status = lcd_8bit_send_command(lcd,0x06);
        Status = lcd_8bit_send_command(lcd,0x0C);
        Status = lcd_8bit_send_command(lcd,0x38);
