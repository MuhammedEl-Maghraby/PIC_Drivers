...
# 14 "MCAL_Layer/ADC/../std_libraries.h"
...
# 14 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h" 1
# 74 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 14 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h" 2
# 98 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
STD_ReturnType ADC_ModuleInitialize(ADC_Cfg_t* _adc){
    ...
    if(_adc != ((void*)0)){
        ...
        (ADCON0bits.CHS = _adc->channel_src);

        (ADCON1bits.PCFG = _adc->analog_digital_cfg);

        do{ADCON1bits.VCFG1 = 0; ADCON1bits.VCFG0 = 0; }while(0);

        (ADCON2bits.ADCS = _adc->clk_conv);
        ...
        (ADCON0bits.ADON = 1);
            ...
            (PIR1bits.ADIF = 0);
# 65 "MCAL_Layer/ADC/hal_adc.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);

        (PIE1bits.ADIE = 1);
        if(ADC_InterruptHandler == ((void*)0)){
...
STD_ReturnType ADC_IsConversionDone(ADC_Cfg_t* _adc ,Conversion_Status_t* conversion_status){
    ...
    if(_adc != ((void*)0) && conversion_status != ((void*)0)){
        *conversion_status = (uint8_t)(!((ADCON0bits.GO_nDONE)));
    }
    else{
        status = (STD_ReturnType)0x00;
    }
