...
# 14 "MCAL_Layer/Timer3/../std_libraries.h"
...
# 12 "MCAL_Layer/Timer3/../compiler.h"
...
# 12 "MCAL_Layer/Timer3/../compiler.h" 2
...
# 14 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
...
# 1 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 15 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/../device_config.h" 1
# 15 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}Logic_t;
...
# 74 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 14 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h" 2
# 98 "MCAL_Layer/Timer3/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
static __attribute__((inline)) STD_ReturnType hal_timer3_interrupt_handler_init(const timer3_t* timer3);
...
STD_ReturnType hal_timer3_read_value(const timer3_t* timer3,uint16_t* value){
    ...
    if(timer3 != ((void*)0) && value != ((void*)0)){
        if(timer3->timer3_rw_mode == 1){
            *value = TMR3;
        }
        else if(timer3->timer3_rw_mode == 0){
...
STD_ReturnType hal_timer3_select_clock_source(const timer3_t* timer3){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer3 != ((void*)0)){
        if(timer3->timer3_mode == 0 && timer3->timer3_clock_source == 0){
            (T3CONbits.TMR3CS = 0);
        }
        else if(timer3->timer3_mode == 1 && timer3->timer3_clock_source == 1){
            (T3CONbits.TMR3CS = 1);
        }
        else{
            status = (STD_ReturnType)0x00;
...
STD_ReturnType hal_timer3_synchronize_external_clock(const timer3_t* timer3){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer3 != ((void*)0)){
        if(timer3->timer3_sync_mode == 0){
            (T3CONbits.nT3SYNC = 0);
        }
        else if(timer3->timer3_sync_mode == 1){
            (T3CONbits.nT3SYNC = 1);
        }
        else{
            status = (STD_ReturnType)0x00;
...
STD_ReturnType hal_timer3_interrupt_enable(const timer3_t* timer3){
    ...
    if(timer3 != ((void*)0)){
        (PIE2bits.TMR3IE = 1);
# 243 "MCAL_Layer/Timer3/hal_timer3.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) STD_ReturnType hal_timer3_interrupt_handler_init(const timer3_t* timer3){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer3 != ((void*)0)){
        if(TMR3_InterruptHandler == ((void*)0) && timer3->TMR3_Handler != ((void*)0)){
...
void Timer3_ISR(void){
    ...
    if(TMR3_InterruptHandler != ((void*)0)){
