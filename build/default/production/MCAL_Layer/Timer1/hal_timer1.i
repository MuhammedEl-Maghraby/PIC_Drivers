...
# 14 "MCAL_Layer/Timer1/../std_libraries.h"
...
# 12 "MCAL_Layer/Timer1/../compiler.h"
...
# 12 "MCAL_Layer/Timer1/../compiler.h" 2
...
# 14 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
...
# 1 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 1
# 15 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
# 1 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/../device_config.h" 1
# 15 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}Logic_t;
...
# 74 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 14 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h" 2
# 98 "MCAL_Layer/Timer1/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
void ADC_ISR(void);
...
static __attribute__((inline)) STD_ReturnType hal_timer1_interrupt_handler_init(const timer1_t* timer1);
...
STD_ReturnType hal_timer1_read_value(const timer1_t* timer1,uint16_t* value){
    ...
    if(timer1 != ((void*)0) && value != ((void*)0)){
        if(timer1->timer1_rw_mode == 1){
            *value = TMR1;
        }
        else if(timer1->timer1_rw_mode == 0){
...
STD_ReturnType hal_timer1_select_clock_source(const timer1_t* timer1){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer1 != ((void*)0)){
        if(timer1->timer1_mode == 0 && timer1->timer1_clock_source == 0){
            (T1CONbits.TMR1CS = 0);
        }
        else if(timer1->timer1_mode == 1 && timer1->timer1_clock_source == 1){
            (T1CONbits.TMR1CS = 1);
        }
        else{
            status = (STD_ReturnType)0x00;
...
STD_ReturnType hal_timer1_synchronize_external_clock(const timer1_t* timer1){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer1 != ((void*)0)){
        if(timer1->timer1_sync_mode == 0){
            (T1CONbits.nT1SYNC = 0);
        }
        else if(timer1->timer1_sync_mode == 1){
            (T1CONbits.nT1SYNC = 1);
        }
        else{
            status = (STD_ReturnType)0x00;
...
STD_ReturnType hal_timer1_config_timer1_oscillator(const timer1_t* timer1){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer1 != ((void*)0)){
        if(timer1->timer1_Osc == 1){
            (T1CONbits.T1OSCEN = 1);
        }
        else if(timer1->timer1_Osc == 0){
            (T1CONbits.T1OSCEN = 0);
        }
        else{
            status = (STD_ReturnType)0x00;
...
STD_ReturnType hal_timer1_interrupt_enable(const timer1_t* timer1){
    ...
    if(timer1 != ((void*)0)){
        (PIE1bits.TMR1IE = 1);
# 260 "MCAL_Layer/Timer1/hal_timer1.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) STD_ReturnType hal_timer1_interrupt_handler_init(const timer1_t* timer1){
    STD_ReturnType status = (STD_ReturnType)0x01;
    if(timer1 != ((void*)0)){
        if(TMR1_InterruptHandler == ((void*)0) && timer1->TMR1_Handler != ((void*)0)){
...
void Timer1_ISR(void){
    ...
    if(TMR1_InterruptHandler != ((void*)0)){
