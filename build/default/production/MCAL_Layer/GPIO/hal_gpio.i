...
# 23 "MCAL_Layer/GPIO/hal_gpio.c"
STD_ReturnType gpio_pin_direction_initialize(const Pin_Config_t * pin_config){
    STD_ReturnType Status = (STD_ReturnType)0x01;
    if(pin_config != ((void*)0) && pin_config->pin < ((uint8)8)){
        switch(pin_config->direction){
            case OUTPUT:
              (*tris_registers[pin_config->port] &= ~(((uint8)1) << pin_config->pin));
                break;
            case INPUT:
              (*tris_registers[pin_config->port] |= (((uint8)1) << pin_config->pin));
                break;
...
STD_ReturnType gpio_pin_get_direction_status(const Pin_Config_t * pin_config , Direction_t * direction_status){
    STD_ReturnType Status = (STD_ReturnType)0x01;
    if(pin_config != ((void*)0) && direction_status != ((void*)0) && pin_config->pin < ((uint8)8)){
           *direction_status = ((*tris_registers[pin_config->port] >> pin_config->pin) & ((uint8)1));
    }
    else{
        Status = (STD_ReturnType)0x00;
    }
...
STD_ReturnType gpio_pin_read_logic(const Pin_Config_t * pin_config , Logic_t * logic){
    STD_ReturnType Status = (STD_ReturnType)0x01;
    if(pin_config != ((void*)0) && logic != ((void*)0) && pin_config->pin < ((uint8)8)){
...
# 237 "MCAL_Layer/GPIO/hal_gpio.c"
STD_ReturnType gpio_port_read_logic(Port_Index_t port,uint8 * logic){
    STD_ReturnType Status = (STD_ReturnType)0x01;
    if(logic != ((void*)0)){
        if(port > ((uint8)5)-1 ){
